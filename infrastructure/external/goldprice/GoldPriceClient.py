...
from domain.external.goldprice.IGoldPriceClient import IGoldPriceClient
from infrastructure.external.goldprice.GoldPriceReturnResponse import GoldPriceReturnResponse
